        ...
        public void onNoDoubleClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.ll_userinfo_bottom_video: // 底部发视频
                    ...
                    boolean showDlg = ModuleMgr.getCenterMgr().getMyInfo().isMan();
                    VideoAudioChatHelper.getInstance().inviteVAChat(UserCheckInfoAct.this, userDetail.getUid(), VideoAudioChatHelper.TYPE_VIDEO_CHAT, showDlg,
