...
public class WheelView extends ScrollView {
    ...
    private void onSelectedCallBack() {
        if (null != onWheelViewListener) {
            // 真实的index应该忽略偏移量
            PLogger.d("---onSelectedCallBack--->isUserScroll：" + isUserScroll + "，selectedIndex："
                    + selectedIndex + "，offset：" + offset + "，items.size()：" + items.size());
        ...
        public void run() {
            ...
            if (initialY - newY == 0) { // stopped
                ...
                final int divided = initialY / itemHeight;
                        ...
                        PLogger.d("===onSelectedCallBack===>initialY：" + initialY + "，remainder：" +
                                remainder + "，itemHeight/2：" + itemHeight / 2);
                if (remainder == 0) {
