...
import com.xiaochen.android.fate_it.module.invoke.Invoker;
...
public class WebPanel extends BasePanel {
    ...
    private void initView() {
        ...
        webView.addJavascriptInterface(new JavaScriptInterface(), "PartyGo");
        webView.loadUrl(url);
    }
    ...
    public class JavaScriptInterface {
        ...
        public String command(String cmd) {
            ...
            try {
                ...
                String cmdReserved = jsonObject.optString("reserved");

                if (TextUtils.isEmpty(cmdReserved)) {
                    Invoker.doInApp(cmdType, cmdData);
                } else {
                    Invoker.doInApp(cmdType, cmdData);
                }
            } catch (Exception e) {
